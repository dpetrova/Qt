...
Q_DECLARE_METATYPE(JobRequest) //used to let the Qt meta-object system know about JobRequest. This is needed to be able to use the class in conjunction with QVariant
